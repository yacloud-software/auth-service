...
require (
	...
	golang.conradwood.net/apis/common v1.1.2889 // indirect
	...
	golang.conradwood.net/apis/goeasyops v1.1.2889 // indirect
	...
	golang.yacloud.eu/apis/session v1.1.2889 // indirect
